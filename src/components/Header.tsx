    ...
    <header className="sticky top-0 z-40 w-full backdrop-blur-md bg-[#f3ede7]/85 border-b border-[#dedcd9]/60 transition-all">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={onReset}>
          <div className="w-8 h-8 rounded-full bg-[#5769e7] flex items-center justify-center text-white shadow-sm">
        ...
        <div className="flex items-center gap-3">
          {showReset && (
            <button
              onClick={onReset}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold text-[#171717] bg-[#f2f1f0] hover:bg-[#ebeae8] transition-colors cursor-pointer border border-[#dedcd9]/60"
            >
