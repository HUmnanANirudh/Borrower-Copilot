    ...
    <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#ebeae8] shadow-sm space-y-5">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <h3 className="text-[28px] font-bold text-[#171717] tracking-tight">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
        <div className="p-4 rounded-2xl bg-[#fcfbf9] border border-[#ebeae8]">
          ...
          <span className="text-[24px] font-bold text-[#171717] block mt-1">
        ...
        <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-200">
          ...
          <span className="text-[24px] font-bold text-amber-950 block mt-1">
