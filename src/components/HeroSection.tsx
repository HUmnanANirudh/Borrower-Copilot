...
export function HeroSection({ onStartQuiz }: HeroSectionProps) {
  return (
    <div className="w-full pt-10 pb-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto text-center space-y-6">
        {/* Pill Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#f2f1f0] border border-[#dedcd9] text-xs font-semibold text-[#171717] shadow-xs">
          <SecurityCheckIcon className="w-4 h-4 text-[#5769e7]" />
          <span>Independent Borrower Protection Engine</span>
        </div>

        {/* Poster Editorial Headline */}
        <h1 className="text-4xl sm:text-6xl font-extrabold text-[#171717] tracking-tight leading-[1.05] sm:leading-[1.02]">
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3.5">
          <button
            onClick={onStartQuiz}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full bg-[#5769e7] hover:bg-[#4958be] text-white text-base font-semibold shadow-md transition-all cursor-pointer transform active:scale-98"
          >
        ...
        <div className="pt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
          <div className="bg-white/80 p-4 rounded-2xl border border-[#dedcd9]/60 menti-card-shadow">
            ...
            <h4 className="text-sm font-bold text-[#171717]">Lender vs Safe Sanction</h4>
          ...
          <div className="bg-white/80 p-4 rounded-2xl border border-[#dedcd9]/60 menti-card-shadow">
            <div className="w-8 h-8 rounded-full bg-[#e4f4e7] text-[#52ad6e] flex items-center justify-center mb-2.5">
              <CoinsSwapIcon className="w-4 h-4" />
            </div>
            <h4 className="text-sm font-bold text-[#171717]">True All-In APR</h4>
          ...
          <div className="bg-white/80 p-4 rounded-2xl border border-[#dedcd9]/60 menti-card-shadow">
            ...
            <h4 className="text-sm font-bold text-[#171717]">100% Stateless & Private</h4>
